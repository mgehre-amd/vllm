...
_gfx11_decode_tile_config: dict[tuple[int, int], tuple[int, int, int]] = {
    ...
    (5120, 3072): (128, 32, 256),
    (3072, 3072): (64, 64, 128),
    (16384, 3072): (128, 32, 256),
    (3072, 8192): (16, 32, 256),
    # Llama-3-8B (hidden=4096, intermediate=14336)
    (6144, 4096): (128, 16, 256),
    (4096, 4096): (128, 16, 256),
    (28672, 4096): (64, 16, 256),
    (4096, 14336): (128, 16, 128),
    # Qwen2.5-VL-3B (hidden=2048, intermediate=11008)
    (2560, 2048): (128, 16, 256),
    (2048, 2048): (128, 16, 256),
    (22016, 2048): (64, 16, 256),
    (2048, 11008): (16, 64, 256),
    # Qwen2.5-VL-7B (hidden=3584, intermediate=18944)
    (4608, 3584): (64, 16, 256),
    (3584, 3584): (64, 16, 256),
    (37888, 3584): (64, 32, 256),
    (3584, 18944): (16, 64, 256),
}
